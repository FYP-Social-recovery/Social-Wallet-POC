...
class WalletImportScreen(UserControl):
    ...
    def continue_click(self,e):
        ...
        ## TODO
        # mnemonic phrases are set for testing need to remove
        if(self.mnemonic_phrase.value=="apart shallow normal poet demise absurd execute famous find high neither chef"):
            # Bob - 1 Owner
            ...
            GlobalState.ENTROPHY_VALUE = 13752494869314140060429097156721397907        
        elif(self.mnemonic_phrase.value=="zone dilemma real cancel expect cradle pave satisfy comfort silver speed work"):
            # Alice - 2 1
            ...
            GlobalState.ENTROPHY_VALUE = 13752494869314140060429097156721397907        
        elif(self.mnemonic_phrase.value=="wonder jazz wall vanish stool track isolate aim hair loyal fatal cause"):
            # Charlie - 3 2
            ...
            GlobalState.ENTROPHY_VALUE = 13752494869314140060429097156721397907        
        elif(self.mnemonic_phrase.value=="payment eight quote olive silly ocean liberty flush electric inside boil physical"):
            # Tom - 4 2
            ...
            GlobalState.ENTROPHY_VALUE = 13752494869314140060429097156721397907        
        elif(self.mnemonic_phrase.value=="curious crash rough make play spirit plate angry biology twenty veteran soul"):
            # Peter - 5 Recover
