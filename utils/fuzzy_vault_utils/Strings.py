...
# Application strings
APP_WELCOME = "Welcome to the fuzzy vault test application!"
...
APP_RETRY_MESSAGE = "Do you want to retry?[y/n] "
APP_BYE = "Bye bye!"
...
APP_RETRY_FP = "Fingerprint was not converted appropriately, please try again..."
