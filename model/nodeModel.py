...
class NodeContractModel:
    ...
    def deploy(publicAddress,privateAddress):
        ...
        # build transaction
        transaction = ContactList.constructor(NodeContractModel.defaultPublicContractAddress).buildTransaction(
            {
                "chainId": chain_id,
